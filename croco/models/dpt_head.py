...
from .linear_head import mask_postprocess, postprocess
...
def create_motion_mask_dpt_head(net):
    ...
    """
    # assert net.dec_depth > 9, f'net.dec_depth: {net.dec_depth}'
    # relax from 9 to 7 considering we use smaller croco backbone
    assert net.dec_depth > 7, f'net.dec_depth: {net.dec_depth}'
