...
from reloc3r_uni.datasets.utils.transforms import ImgNorm
import reloc3r_uni.datasets.utils.cropping as cropping
from .easy_dataset import EasyDataset
from pdb import set_trace as bb
from mvp3r.utils.geometry import depthmap_to_absolute_camera_coordinates
...
class BaseStereoViewDataset (EasyDataset):
    ...
    def __getitem_img_only__(self, idx):
        '''
        reloc3r ones. overwrite
        '''
        if isinstance(idx, tuple):
            # the idx is specifying the aspect-ratio
            idx, ar_idx = idx
    ...
    def _crop_resize_if_necessary_with_depth(self, image, depthmap, intrinsics, resolution, rng=None, info=None):
        """ This function:
        extend from dust3r for depth resizing.
        ...
        # print('/////current img size_wh and resolution',image.size, resolution)
